// ==UserScript==
// @name         CivicPlus - Multiple Quick Links
// @namespace    http://civicplus.com/
// @version      1.0.0
// @description  Enhances the QuickLinks admin page to allow adding multiple quick link items at once in CivicPlus admin pages.
// @author       CivicPlus
...
(function () {
  ...
  window.MultipleQuickLinks = {
    ...
    init: async function () {
      ...
      try {
        // Ensure we are on the QuickLinks admin page
         ...
         * Uses MutationObserver for efficiency and times out after the specified number of milliseconds.
         ...
         */
        function appendUI() {
          // Identify the inner wrapper div (the original code targeted the first inner div within the .formline container).
  ...
  window.MultipleQuickLinks.init();
})();