...
(function() {
    ...
    async function init() {
        if (
            typeof window.CPToolkit !== 'undefined' &&
            typeof window.CPToolkit.isCivicPlusSite === 'function'
        ) {
        ...
        try {
            $(document).ready(function() {
                ...
                function newModifyButtonFunction() {
                    ...
                    console.log(
                        TOOLKIT_NAME + ' This button is ' + currentButtonStyleSelector
                    );
                    ...
                    $('textarea.autoUpdate').each(function() {
                        if (currentButtonStyleSelector === 'fancyButton1') {
                            $(this)
                                .parent()
                                .prepend(
                                    "<p style='color: red;'><i>Button not saved yet. Edit again after saving.</i></p>"
                                );
                        }
                        ...
                        $(this)
                            .parent()
                            .prepend(
                                "<p>[CP Toolkit] <i>Use .fancyButton1 as selector.</i></p>"
                            );
                    ...
                    const oldInsertFancyButtonFunction =
                        insertEvents.click[0].handler;
                    ...
                    function newInsertFancyButton(e) {
                        ...
                        const newClass = $('.fancyButtonContainer a.fancyButton')
                            .attr('class')
                            .replace(
                                new RegExp('fancyButton1', 'g'),
                                currentButtonStyleSelector
                            );

                        $('.fancyButtonContainer a.fancyButton').attr(
                            'class',
                            newClass
                        );
                    }
